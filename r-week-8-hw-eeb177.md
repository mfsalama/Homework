...
The which command returns the index of every TRUE value in its input.
The names(x) == "g" command didn’t return any TRUE values. Because there
were no TRUE values passed to the which command, it returned an empty
vector. Negating this vector with the minus sign didn’t change its
...
because the vector type of x is “named numeric” since we assigned names
to the values (try str(x) ).
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-28-1.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-29-1.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-30-1.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-31-1.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-32-1.png)
...
![](r-week-8-hw-eeb177_files/figure-markdown_strict/unnamed-chunk-33-1.png)
